    ...
    templates: (prev) => [
      ...
      managedPageTemplate(
        ...
        [
          ...
          textItem('admin.stats.categoriesTitle', 'Categories Link Card Title', 'Quản lý danh mục'),
          textItem('admin.stats.categoriesDescription', 'Categories Link Card Description', 'Danh mục & Form xác thực'),
          ...
          textItem('admin.stats.loginBrandingTitle', 'Login Customizer Link Card Title', 'Ô login & đăng ký', 'Ô login & đăng ký', 'Login & register panels'),
          textItem('admin.stats.loginBrandingDescription', 'Login Customizer Link Card Description', 'Chỉnh ở bên trái trong Sanity', 'Chỉnh ở bên trái trong Sanity', 'Edit left panels in Sanity'),
